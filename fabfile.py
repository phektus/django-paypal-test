...
env.hosts = ['hr_payment.wemakeprojects.com']
env.root = '/opt/webapps/hr_payment'
env.proj_root = env.root + '/src/hr_payment'
...
def clone():
    ...
    with cd('%s/hr_payment/conf/local' % env.proj_root):
