...
SECRET_KEY = 'h!9$)k@scta*5gf^#i=xso+6hz(33*yr1+u28rsd7u=tw$ti2_'
...
PROJECT_DIR, PROJECT_MODULE_NAME = os.path.split(
    os.path.dirname(os.path.realpath(hr_payment.__file__))
)
...
ROOT_URLCONF = 'hr_payment.conf.urls'
...
PAYPAL_RECEIVER_EMAIL = "arbie@sportix.fr"
